...
if __name__ == "__main__":
    ...
    parser.add_argument("--lora_name", type=str, default="lora_politics_identity0422")
    # ====================== 核心修改 ======================
    parser.add_argument("--epochs", type=int, default=10, help="只训2轮！10轮必过拟合废掉")
    parser.add_argument("--batch_size", type=int, default=16)
    parser.add_argument("--learning_rate", type=float, default=2e-4, help="LoRA最稳学习率")
    parser.add_argument("--accumulation_steps", type=int, default=1, help="4090不需要累积")
    # ======================================================
    ...
    parser.add_argument("--data_path", type=str, default="../dataset/ideological_politics_suiji04221.jsonl")
    ...
    parser.add_argument("--use_compile", default=0, type=int)
